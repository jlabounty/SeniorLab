...
Using these to calculate the Al-Cu ratio of free electrons yields $ \frac{e^{-}_{Al}}{e^{-}_{Cu}} = 2.65 \pm 0.26$ for $25^{\circ}$ and $\frac{e^{-}_{Al}}{e^{-}_{Cu}} = 2.73 \pm 0.0.27$ for $45^{\circ}$. These two values are consistent with each other, and, as we will discuss later, are consistent with the expected range of values based on theory.
