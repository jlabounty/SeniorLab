...
We can see that these known values are not perfectly in line with the 'hard-sphere' model of the atom. In the coming section, we will compare these two theoretical values with out experimental data.
